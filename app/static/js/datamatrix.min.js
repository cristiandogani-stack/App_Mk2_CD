    ...
    function DATAMatrix( Q ) {
        ...
        ,toAscii = function( t ) {
                ...
                for( var i = 0; i < l; i++ ) {
                        ...
                        if( c > 47 && c < 58 && c1 > 47 && c1 < 58 ) { /* 2 
digits */

                                r.push( ( c - 48 ) * 10 + c1 + 82 ), /* - 48 + 
130 = 82 */
                                i++;
        ...
        ,toBase = function( t ) {
                ...
                if( 250 < l ) {
                        ...
                        r.push( 37 + ( l / 250 | 0 ) & 255 ); /* length high 
byte (in 255 state algo) */
                }
                ...
                for( var i = 0; i < l; i++ ) {
                        ...
                        r.push( t.charCodeAt( i ) + 149 * ( r.length + 1 ) % 255
  + 1 & 255 ); /* data in 255 state algo */
                }
...
set */
                ...
                return l > n ? r : r.concat( toAscii( t.substr( l == 0 ? 0 : l -
  1 ) ) ); /* last chars*/
        }
...
return []; /* char not in set or padding fails */
                        ...
                        if( x < 5 && cc == 2 && i == l-1) break; /* last char in
 ASCII */
                        if( x < 5 ) push( x ); /* shift */
        ...
        ,encodeMsg = function( text, rct ) {
                ...
                var
                h, w, nc = 1, nr = 1, fw, fh, /* symbol size, regions, region 
size */
  ...
  */
                        ...
                        w = h = 6;
                        i = 2; /* size increment */
                        k = [ 5, 7, 10, 12, 14, 18, 20, 24, 28, 36, 42, 48, 56, 
68, 84, 112, 144, 192, 224, 272, 336, 408, 496, 620 ]; /* rs checkwords */

                        do {
                                if( ++j == k.length ) return [ 0, 0 ]; /* msg is
  too long */

                                if( w > 11 * i ) i = 4 + i & 12; /* advance 
increment */
...
regions */
                ...
                for( j = 1, i = 0; i < 255; i++ ) { 
                        ...
                        if( j > 255 ) j ^= 301; /* 301 == a^8 + a^5 + a^3 + a^2 
 + 1 */
                }
...
0 ) {
                                ...
                                else if( r == 1 && c == w - 1 && ( w & 7 ) == 0 
&& ( h & 7 ) == 6 ) continue; /* omit corner D */
